...
function getFileHash(content, len){
  ...
  var onEnd = function (cb) {
    ...
    async.parallel([
      ...
      var spritesheetData = {
        ...
        image: spritePath + (params.hash ? '?hash=' + getFileHash(imgFile.contents, 8) : '')
      };
      ...
      if (retinaResult) {
        ...
        retinaSpritesheetInfo = {
          ...
          image: retinaSpritePath + (params.hash ? '?hash=' + getFileHash(retinaImgFile.contents, 8) : '')
        };
